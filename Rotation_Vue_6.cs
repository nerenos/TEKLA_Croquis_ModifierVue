...
namespace UserMacros {
    public sealed class Macro {
        ...
        public static void Run(Tekla.Macros.Runtime.IMacroRuntime runtime) {
            ...
            akit.ValueChange("adraw_dial", "gr_dv_coord_sys_x_rotate", "90");
            akit.ValueChange("adraw_dial", "gr_dv_coord_sys_y_rotate", "180");
            akit.ValueChange("adraw_dial", "gr_dv_coord_sys_z_rotate", "0.000000000000");
            akit.ModalDialog(1);
